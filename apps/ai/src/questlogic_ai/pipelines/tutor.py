...
def _build_system_prompt(*, subject_slug: str, node_title: str, node_summary: str) -> str:
    ...
    return (
        ...
        "- The history is provided for context. Your job is to address the student's "
        "  latest message only.\n"
        "- Never begin a response by recapping or summarizing earlier turns. The student "
        "  read your previous response; trust them.\n"
        "- A correction made in an earlier turn is settled. Don't restate it.\n"
        "\n"
        "Signalling mastery:\n"
